...
export interface StepData extends Document {
  ...
  basicInfo: {
    firstNameOfDeceased?: string; // Changed from nameOfDeceased
    lastNameOfDeceased?: string;  // Added lastNameOfDeceased
...
const CombinedFormSchema: Schema<StepData> = new Schema(
  {
    ...
    basicInfo: {
      firstNameOfDeceased: { type: String, required: false }, // Changed from nameOfDeceased
      lastNameOfDeceased: { type: String, required: false },  // Added lastNameOfDeceased
